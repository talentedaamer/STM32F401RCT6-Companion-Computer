/*
 * BACKUP - this was main.c before the VL53L0X I2C distance-sensor test.
 * Not compiled (not in the Makefile's CSRC list) - kept for reference so
 * the MAVLink RTL-redirect + dummy obstacle avoidance work isn't lost.
 * To restore: copy this back over main.c and re-add mavlink_bridge.c /
 * dummy_obstacle.c to the Makefile's CSRC list.
 *
